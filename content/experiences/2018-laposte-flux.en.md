...
tags: Python, Angular, Docker, Agile, Sys Admin Linux
...
The main undertaking: the complete migration of an existing PHP application to a Python/Angular stack, without interrupting the service. Among the highlights, the optimisation of a file-processing task whose execution time went from 25 minutes to under one second.
