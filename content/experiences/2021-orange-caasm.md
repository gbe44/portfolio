...
tags: Full-stack, Python, Flask, FastAPI, Celery, React, MySQL, Docker, Redis, Microservices, API REST, Event-driven, Traitement Asynchrone, Tenable.sc, TestSSL, CI/CD, Artifactory, Sys Admin Linux, Secure SDLC, OWASP Top 10, RGPD, Threat Intelligence, Gestion des vulnérabilités
