...
summary: Technical lead of a cyber attack-surface mapping tool with 150k+ assets inventoried and 50+ automated scans per week.
cv: true
cv_points:
...
Outcome: about 70 days per year saved for the main user, 50+ automated scans per week and a significant reduction in vulnerabilities.
