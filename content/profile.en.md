...
cv_skill_groups:
  ...
  - Security | Secure SDLC, OWASP Top 10, Vulnerability Management, Tenable.sc, TestSSL
  - Architecture | Microservices, REST API, Event-driven, Task Scheduling, Asynchronous Processing
  - Industrialization & System | Linux, Docker, CI/CD, Artifactory, Bash, Grafana
  - Databases | MySQL, PostgreSQL, Redis
  - Languages | French (native), English (B2)
site_skill_groups:
  - Languages and Frameworks | Python, PHP, Javascript, HTML, CSS, Flask, FastAPI, React, Angular
  - Security | Secure SDLC, OWASP Top 10, GDPR, Threat Intelligence, Vulnerability Management, Tenable.sc, TestSSL
  - Architecture | Microservices, REST API, API, Event-driven, Celery, Asynchronous Processing, Web scraping, Full-stack
  - Industrialization & System | Sys Admin Linux, Docker, CI/CD, Artifactory, Bash, Grafana, GitHub Pages
  - Databases | MySQL, PostgreSQL, Redis
  - AI & Explorations | AI, LLM, Agents, Game design, Crypto
